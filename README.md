...
## Projects
* [**Dancing robot project**](https://github.com/janaStani/Dancing-Robot-Project) done for the Introduction to Robotics course using Parallax BoeBot, written in Arduino (C++)
* [**Line following robot with splits, marks and gaps**](https://github.com/janaStani/Robot-Line-Following-splits-marks-gaps) handling assignment done for the Introduction to Robotics course using Parallax BoeBot, written in Arduino (C++)
